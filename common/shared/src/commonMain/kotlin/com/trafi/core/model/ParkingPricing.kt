 ...
 * @param dailyRate
 * @param monthlyRate
 * @param timeIntervalPrices If set and non-empty, this overrides the pricing.  E.g., you can specify that first 1 hour cost 2 EUR, second 2 hours cost 3 EUR.  The intervals don't need to be the same length.  If parking lasts longer than the sum of all interval lengths,  price calculation should fall back to hourly/daily/monthly pricing.
 */
@Serializable
data class ParkingPricing(
    ...
    @SerialName(value = "dailyRate") val dailyRate: kotlin.Double? = null,
    @SerialName(value = "monthlyRate") val monthlyRate: kotlin.Double? = null,
    /* If set and non-empty, this overrides the pricing.  E.g., you can specify that first 1 hour cost 2 EUR, second 2 hours cost 3 EUR.  The intervals don't need to be the same length.  If parking lasts longer than the sum of all interval lengths,  price calculation should fall back to hourly/daily/monthly pricing. */
    @SerialName(value = "timeIntervalPrices") val timeIntervalPrices: kotlin.collections.List<ParkingTimeIntervalPricing>? = null
)
