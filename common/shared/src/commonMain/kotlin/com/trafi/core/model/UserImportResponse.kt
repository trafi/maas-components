...
data class UserImportResponse(
    ...
    @SerialName(value = "result") val result: UserImportResponse.Result? = null
) {
    ...
    enum class Result(val value: kotlin.String) {
        ...
        object Serializer : CommonEnumSerializer<Result>("Result", values(), values().map { it.value.toString() }.toTypedArray())
    }
}
