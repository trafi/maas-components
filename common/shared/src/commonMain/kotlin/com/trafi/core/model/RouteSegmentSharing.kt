...
data class RouteSegmentSharing(
    ...
    @SerialName(value = "startStation") val startStation: Station? = null,
    @SerialName(value = "vehicle") val vehicle: SharedVehicle? = null,
    @SerialName(value = "endParkingSpot") val endParkingSpot: ParkingSpot? = null,
    @SerialName(value = "endStation") val endStation: Station? = null,
    @SerialName(value = "provider") val provider: Provider? = null,
    @SerialName(value = "drivingInfo") val drivingInfo: DrivingInfo? = null
)
