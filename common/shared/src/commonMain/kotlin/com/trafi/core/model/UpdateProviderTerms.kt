 ...
 */
@Serializable
data class UpdateProviderTerms(
    @SerialName(value = "key") @Required val key: kotlin.String,
    @SerialName(value = "version") @Required val version: kotlin.String,
    @SerialName(value = "action") @Required val action: UpdateProviderTerms.Action,
    @SerialName(value = "receivedAt") val receivedAt: kotlin.String? = null
) {

    /**
     *
     * Values: DECLINE,ACCEPT
     */
