 ...
 */
@Serializable
data class LocalizedPropertyValues(
    @SerialName(value = "propertyId") @Required val propertyId: kotlin.String,
    @SerialName(value = "key") @Required val key: kotlin.String,
    @SerialName(value = "localizedValues") @Required val localizedValues: kotlin.collections.List<LocalizedPropertyValue>
)
