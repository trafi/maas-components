 ...
 * @param fareEstimate
 * @param polyline
 * @param emptyStateMessageKey
 * @param offerTimeout
 */
@Serializable
data class RideHailingBookingEstimate(
    ...
    @SerialName(value = "pickupEta") @Required val pickupEta: Eta,
    @SerialName(value = "pickup") val pickup: Location? = null,
    @SerialName(value = "destinationEta") val destinationEta: Eta? = null,
    @SerialName(value = "fareEstimate") val fareEstimate: FareEstimate? = null,
    @SerialName(value = "polyline") val polyline: kotlin.String? = null,
    @SerialName(value = "emptyStateMessageKey") val emptyStateMessageKey: kotlin.String? = null,
    @SerialName(value = "offerTimeout") val offerTimeout: kotlin.String? = null
)
