 ...
 */
@Serializable
data class CreateSharingBookingRequest(
    ...
    @SerialName(value = "initialBookingStatus") val initialBookingStatus: CreateSharingBookingRequest.InitialBookingStatus? = null
) {
     ...
     */
    @Serializable(with = InitialBookingStatus.Serializer::class)
    enum class InitialBookingStatus(val value: kotlin.String) {
        RESERVED("RESERVED"),
        LEASED("LEASED"),
        FINISHED("FINISHED"),
        CANCELED("CANCELED"),
        ...
        object Serializer : CommonEnumSerializer<InitialBookingStatus>("InitialBookingStatus", values(), values().map { it.value.toString() }.toTypedArray())
    }
}
