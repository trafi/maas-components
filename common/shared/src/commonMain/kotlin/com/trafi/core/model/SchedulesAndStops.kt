 ...
 *
 * @param schedules
 * @param stopsWithSchedules
 */
@Serializable
data class SchedulesAndStops(
    @SerialName(value = "schedules") @Required val schedules: kotlin.collections.List<Schedule>,
    @SerialName(value = "stopsWithSchedules") @Required val stopsWithSchedules: kotlin.collections.List<StopWithSchedules>
)
