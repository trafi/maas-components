 ...
 * @param timeIntervalPrices
 * @param fees
 */
@Serializable
data class SharingPricing(
    @SerialName(value = "minimum") val minimum: kotlin.Double? = null,
    @SerialName(value = "minimumMinutes") val minimumMinutes: kotlin.Int? = null,
    @SerialName(value = "base") val base: kotlin.Double? = null,
    @SerialName(value = "minute") val minute: kotlin.Double? = null,
    @SerialName(value = "hour") val hour: kotlin.Double? = null,
    @SerialName(value = "day") val day: kotlin.Double? = null,
    @SerialName(value = "week") val week: kotlin.Double? = null,
    @SerialName(value = "perKilometer") val perKilometer: kotlin.Double? = null,
    @SerialName(value = "freeKilometers") val freeKilometers: kotlin.Double? = null,
    @SerialName(value = "timeIntervalPrices") val timeIntervalPrices: kotlin.collections.List<TimeIntervalPricing>? = null,
    @SerialName(value = "fees") val fees: kotlin.collections.List<Fee>? = null
)
