...
data class ExtendedExactDeparture(
    ...
    @SerialName(value = "scheduledDepartureStatus") @Required val scheduledDepartureStatus: ExtendedExactDeparture.ScheduledDepartureStatus,
     ...
     */
    @Serializable(with = ScheduledDepartureStatus.Serializer::class)
    enum class ScheduledDepartureStatus(val value: kotlin.String) {
        ...
        object Serializer : CommonEnumSerializer<ScheduledDepartureStatus>("ScheduledDepartureStatus", values(), values().map { it.value.toString() }.toTypedArray())
    }
}
