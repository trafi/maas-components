...
@Serializable
data class Records(
    @SerialName(value = "rideHailing") @Required val rideHailing: kotlin.collections.List<RideHailingRecord>,
    @SerialName(value = "sharing") @Required val sharing: kotlin.collections.List<SharingRecord>,
    @SerialName(value = "tickets") @Required val tickets: kotlin.collections.List<TicketsRecord>,
    @SerialName(value = "ticketActivations") @Required val ticketActivations: kotlin.collections.List<TicketActivationsRecord>,
    @SerialName(value = "parking") @Required val parking: kotlin.collections.List<ParkingRecord>,
    @SerialName(value = "subscriptionRenewals") @Required val subscriptionRenewals: kotlin.collections.List<SubscriptionRenewalRecord>
)
