 ...
 */
@Serializable
data class StopWithSchedulesWithDeparturesByDestinationWithDirections(
    @SerialName(value = "stop") @Required val stop: StopWithSchedulesWithDeparturesByDestination,
