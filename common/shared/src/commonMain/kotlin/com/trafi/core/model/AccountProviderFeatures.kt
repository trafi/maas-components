...
data class AccountProviderFeatures(
    @SerialName(value = "supportsConnect") val supportsConnect: kotlin.Boolean? = null,
    @SerialName(value = "supportsRegistration") val supportsRegistration: kotlin.Boolean? = null,
    @SerialName(value = "requiresPayment") val requiresPayment: kotlin.Boolean? = null
)
