...
data class SharingProviderOptions(
    @SerialName(value = "vehicleType") @Required val vehicleType: SharingProviderOptions.VehicleType,
    ...
    @SerialName(value = "routing") val routing: SharingRoutingOptions? = null,
