...
/**
 *
 * @param sharingBookingStatus
 * @param coordinates
 */
@Serializable
data class UpdateSharingBookingRequest(
    @SerialName(value = "sharingBookingStatus") @Required val sharingBookingStatus: UpdateSharingBookingRequest.SharingBookingStatus,
     ...
     */
    @Serializable(with = SharingBookingStatus.Serializer::class)
    enum class SharingBookingStatus(val value: kotlin.String) {
        ...
        object Serializer : CommonEnumSerializer<SharingBookingStatus>("SharingBookingStatus", values(), values().map { it.value.toString() }.toTypedArray())
    }
}
