...
data class ParkingSession(
    ...
    @SerialName(value = "status") @Required val status: ParkingSession.Status,
    ...
    @SerialName(value = "parkingZoneCode") @Required val parkingZoneCode: kotlin.String,
    @SerialName(value = "fromTime") @Required val fromTime: kotlin.String,
    @SerialName(value = "toTime") @Required val toTime: kotlin.String,
    @SerialName(value = "price") @Required val price: ParkingPrice,
    @SerialName(value = "statusInfo") val statusInfo: SessionStatusInfo? = null
) {

    /**
     *
     * Values: FAILED,CONFIRMED,PENDING
     */
