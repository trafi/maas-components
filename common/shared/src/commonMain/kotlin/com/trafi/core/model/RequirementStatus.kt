 ...
 * @param details
 * @param keys
 * @param unacceptedTerms
 */
@Serializable
data class RequirementStatus(
    @SerialName(value = "fulfilled") val fulfilled: kotlin.Boolean? = null,
    @SerialName(value = "details") val details: kotlin.String? = null,
    @SerialName(value = "keys") val keys: kotlin.collections.List<kotlin.String>? = null,
    @SerialName(value = "unacceptedTerms") val unacceptedTerms: kotlin.collections.List<Terms>? = null
)
