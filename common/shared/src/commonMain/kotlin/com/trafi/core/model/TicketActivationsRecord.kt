 ...
 */
@Serializable
data class TicketActivationsRecord(
    @SerialName(value = "providerId") @Required val providerId: kotlin.String,
    @SerialName(value = "ticket") @Required val ticket: HistoryTicket,
    @SerialName(value = "activatedCount") @Required val activatedCount: kotlin.Int,
    @SerialName(value = "validFrom") @Required val validFrom: kotlin.String,
    @SerialName(value = "validTo") @Required val validTo: kotlin.String,
