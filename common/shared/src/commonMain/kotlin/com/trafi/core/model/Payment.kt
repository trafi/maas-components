...
@Serializable
data class Payment(
    @SerialName(value = "price") @Required val price: HistoryMoney,
    @SerialName(value = "priceBreakdown") val priceBreakdown: HistoryPriceBreakdown? = null,
    @SerialName(value = "purchaseBreakdown") val purchaseBreakdown: HistoryPurchaseBreakdown? = null,
    @SerialName(value = "method") val method: HistoryPaymentMethod? = null,
    @SerialName(value = "invoiceUrls") val invoiceUrls: kotlin.collections.List<kotlin.String>? = null,
    @SerialName(value = "isInvoiceAvailable") val isInvoiceAvailable: kotlin.Boolean? = null
)
