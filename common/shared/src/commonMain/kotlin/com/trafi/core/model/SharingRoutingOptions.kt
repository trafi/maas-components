...
data class SharingRoutingOptions(
    @SerialName(value = "shouldRouteFromStations") @Required val shouldRouteFromStations: kotlin.Boolean,
    @SerialName(value = "baseDuration") val baseDuration: kotlin.String? = null
)
