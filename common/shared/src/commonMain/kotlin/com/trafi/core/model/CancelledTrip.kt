 ...
 */
@Serializable
data class CancelledTrip(
    @SerialName(value = "startLocation") @Required val startLocation: Location,
    @SerialName(value = "endLocation") @Required val endLocation: Location,
    @SerialName(value = "createdAt") @Required val createdAt: kotlin.String,
    @SerialName(value = "cancelledAt") @Required val cancelledAt: kotlin.String
)
