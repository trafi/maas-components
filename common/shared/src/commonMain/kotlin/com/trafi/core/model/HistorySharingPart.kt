...
data class HistorySharingPart(
    ...
    @SerialName(value = "providers") @Required val providers: kotlin.collections.List<HistorySharingProvider>,
    @SerialName(value = "duration") val duration: HistoryBalanceDuration? = null,
    @SerialName(value = "meters") val meters: HistoryBalanceMeters? = null
)
