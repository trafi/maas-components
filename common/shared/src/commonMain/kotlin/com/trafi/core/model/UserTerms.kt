...
data class UserTerms(
    @SerialName(value = "platformTerms") @Required val platformTerms: kotlin.collections.List<AcceptedPlatformTerms>,
    @SerialName(value = "providerTerms") @Required val providerTerms: kotlin.collections.List<AcceptedProviderTerms>,
    @SerialName(value = "declinedPlatformTerms") @Required val declinedPlatformTerms: kotlin.collections.List<DeclinedPlatformTerms>,
    @SerialName(value = "declinedProviderTerms") @Required val declinedProviderTerms: kotlin.collections.List<DeclinedProviderTerms>
)
