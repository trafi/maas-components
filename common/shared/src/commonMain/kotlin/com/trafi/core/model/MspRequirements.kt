...
data class MspRequirements(
    @SerialName(value = "resourceSpecifier") val resourceSpecifier: ResourceSpecifier? = null,
    @SerialName(value = "requirementStatuses") val requirementStatuses: kotlin.collections.Map<kotlin.String, RequirementStatus>? = null
)
