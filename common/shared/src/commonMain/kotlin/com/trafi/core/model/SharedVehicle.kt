...
data class SharedVehicle(
    ...
    @SerialName(value = "deepLinks") @Required val deepLinks: kotlin.collections.List<LocalizedDeepLink>,
    @SerialName(value = "name") val name: kotlin.String? = null,
    @SerialName(value = "vehicleType") val vehicleType: SharedVehicle.VehicleType? = null,
    ...
    @SerialName(value = "pricing") val pricing: SharingPricingInfo? = null,
    ...
    /**
     *
     * Values: CAR,BICYCLE,SCOOTER,KICK_SCOOTER
     */
    @Serializable(with = VehicleType.Serializer::class)
    enum class VehicleType(val value: kotlin.String) {
        ...
        object Serializer : CommonEnumSerializer<VehicleType>("VehicleType", values(), values().map { it.value.toString() }.toTypedArray())
    }
}
