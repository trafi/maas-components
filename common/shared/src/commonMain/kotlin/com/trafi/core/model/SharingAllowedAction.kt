...
/**
 *
 * @param action Action allowed to be performed when booking status is Trafi.Platform.Contract.Ondemand.Sharing.SharingAllowedAction.BookingStatus
 * @param bookingStatus Current booking status
 */
@Serializable
data class SharingAllowedAction(
    /* Action allowed to be performed when booking status is Trafi.Platform.Contract.Ondemand.Sharing.SharingAllowedAction.BookingStatus */
    @SerialName(value = "action") @Required val action: SharingAllowedAction.Action,
    /* Current booking status */
    @SerialName(value = "bookingStatus") val bookingStatus: SharingAllowedAction.BookingStatus? = null
) {
    ...
    enum class Action(val value: kotlin.String) {
        ...
        object Serializer : CommonEnumSerializer<Action>("Action", values(), values().map { it.value.toString() }.toTypedArray())
    }
    /**
     * Current booking status
    ...
    enum class BookingStatus(val value: kotlin.String) {
        ...
        object Serializer : CommonEnumSerializer<BookingStatus>("BookingStatus", values(), values().map { it.value.toString() }.toTypedArray())
    }
}
