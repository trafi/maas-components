 ...
 * @param parkingOptions
 */
@Serializable
data class EstimateParkingPriceResponse(
    @SerialName(value = "fareId") @Required val fareId: kotlin.String,
    @SerialName(value = "fareToken") @Required val fareToken: kotlin.String,
    ...
    @SerialName(value = "parkingOptions") @Required val parkingOptions: kotlin.collections.List<ParkingOption>
)
