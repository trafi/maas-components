 ...
 */
@Serializable
data class SharingPricingInfo(
    @SerialName(value = "currency") val currency: kotlin.String? = null,
    @SerialName(value = "current") val current: SharingPricing? = null,
    @SerialName(value = "workday") val workday: SharingPricing? = null,
    @SerialName(value = "weekend") val weekend: SharingPricing? = null,
    @SerialName(value = "parking") val parking: SharingPricing? = null,
    @SerialName(value = "feeInfo") val feeInfo: kotlin.collections.List<FeeInfo>? = null
)
