...
data class HistoryPurchaseBreakdown(
    @SerialName(value = "payment") val payment: HistoryPaymentPurchaseBreakdownItem? = null,
    @SerialName(value = "subscription") val subscription: HistorySubscriptionPurchaseBreakdownItem? = null
)
