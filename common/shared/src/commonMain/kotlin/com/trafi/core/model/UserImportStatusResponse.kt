 ...
 * @param state The current state of data import
 */
@Serializable
data class UserImportStatusResponse(
    /* The current state of data import */
    @SerialName(value = "state") val state: UserImportStatusResponse.State? = null
) {
    ...
    enum class State(val value: kotlin.String) {
        ...
        object Serializer : CommonEnumSerializer<State>("State", values(), values().map { it.value.toString() }.toTypedArray())
    }
}
