 ...
 *
 * @param pricing
 * @param hoursOfControl
 */
@Serializable
data class Tariff(
    @SerialName(value = "pricing") @Required val pricing: ParkingPricing,
    @SerialName(value = "hoursOfControl") @Required val hoursOfControl: HoursOfControl
)
