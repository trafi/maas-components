 ...
 */
@Serializable
data class RideHailingPricing(
    @SerialName(value = "additionalFees") @Required val additionalFees: kotlin.collections.List<AdditionalFee>,
    @SerialName(value = "minimumKilometers") val minimumKilometers: kotlin.Double? = null,
    ...
    @SerialName(value = "waitPerMinute") val waitPerMinute: kotlin.Double? = null,
    @SerialName(value = "ridePerMinute") val ridePerMinute: kotlin.Double? = null
)
