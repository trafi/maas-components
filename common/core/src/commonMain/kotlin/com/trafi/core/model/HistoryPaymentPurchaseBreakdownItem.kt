...
data class HistoryPaymentPurchaseBreakdownItem(
    ...
    @SerialName(value = "vatRatePercent") val vatRatePercent: kotlin.Double? = null,
    @SerialName(value = "vatAmount") val vatAmount: kotlin.Double? = null,
    @SerialName(value = "sharing") val sharing: HistorySharingPurchaseBreakdownInfo? = null
)
