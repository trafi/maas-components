...
data class SubscriptionBreakdownItem(
    @SerialName(value = "subscriptionAllowanceTransactionId") val subscriptionAllowanceTransactionId: kotlin.Int? = null,
    @SerialName(value = "sharing") val sharing: SharingBreakdownItem? = null
)
