...
data class RequirementStatusResponse(
    ...
    @SerialName(value = "requirementInterdependence") @Required val requirementInterdependence: kotlin.collections.Map<kotlin.String, kotlin.collections.List<kotlin.String>>,
    @SerialName(value = "requirementStatuses") @Required val requirementStatuses: kotlin.collections.Map<kotlin.String, RequirementStatus>
)
