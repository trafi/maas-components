...
data class RideHailingAllowedAction(
    @SerialName(value = "bookingStatus") val bookingStatus: RideHailingAllowedAction.BookingStatus? = null,
    @SerialName(value = "action") val action: RideHailingAllowedAction.Action? = null
) {
