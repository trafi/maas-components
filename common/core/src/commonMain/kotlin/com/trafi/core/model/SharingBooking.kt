...
data class SharingBooking(
    ...
    @SerialName(value = "status") @Required val status: SharingBooking.Status,
    ...
    @SerialName(value = "timeRemaining") val timeRemaining: Duration? = null,
    @SerialName(value = "timeElapsed") val timeElapsed: Duration? = null,
    @SerialName(value = "timePaused") val timePaused: Duration? = null,
    @SerialName(value = "createdAt") val createdAt: kotlin.String? = null,
    @SerialName(value = "leasedAt") val leasedAt: kotlin.String? = null,
    ...
    @SerialName(value = "unlockInfo") val unlockInfo: UnlockInfo? = null,
    @SerialName(value = "notificationSettings") val notificationSettings: NotificationSettings? = null,
    @SerialName(value = "priceBreakdown") val priceBreakdown: PriceBreakdown? = null,
    @SerialName(value = "purchaseBreakdown") val purchaseBreakdown: PurchaseBreakdown? = null,
    @SerialName(value = "distanceMeters") val distanceMeters: kotlin.Int? = null,
