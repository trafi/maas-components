 ...
 */
@Serializable
data class LocalizedDeepLink(
    @SerialName(value = "android") @Required val android: DeepLink,
    @SerialName(value = "ios") @Required val ios: DeepLink,
    @SerialName(value = "languageCode") val languageCode: kotlin.String? = null
)
