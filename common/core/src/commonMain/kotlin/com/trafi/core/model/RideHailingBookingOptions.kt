...
/**
 *
 * @param passengerCountRequired
 * @param maxPassengerCount
 * @param allowedActions
 * @param supportedTags
 * @param startAddressRequired
 * @param endAddressRequired
 * @param cancellationFee
 */
@Serializable
data class RideHailingBookingOptions(
    @SerialName(value = "passengerCountRequired") val passengerCountRequired: kotlin.Boolean? = null,
    @SerialName(value = "maxPassengerCount") val maxPassengerCount: kotlin.Int? = null,
    @SerialName(value = "allowedActions") val allowedActions: kotlin.collections.List<RideHailingAllowedAction>? = null,
    @SerialName(value = "supportedTags") val supportedTags: kotlin.collections.List<kotlin.String>? = null,
    @SerialName(value = "startAddressRequired") val startAddressRequired: kotlin.Boolean? = null,
    @SerialName(value = "endAddressRequired") val endAddressRequired: kotlin.Boolean? = null,
    @SerialName(value = "cancellationFee") val cancellationFee: kotlin.Double? = null
)
