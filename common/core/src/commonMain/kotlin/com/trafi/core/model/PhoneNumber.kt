...
data class PhoneNumber(
    @SerialName(value = "verificationStatus") @Required val verificationStatus: PhoneNumber.VerificationStatus,
    ...
    enum class VerificationStatus(val value: kotlin.String) {
        ...
        object Serializer : CommonEnumSerializer<VerificationStatus>("VerificationStatus", values(), values().map { it.value.toString() }.toTypedArray())
    }
}
