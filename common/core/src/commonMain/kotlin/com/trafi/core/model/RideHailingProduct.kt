...
data class RideHailingProduct(
    ...
    @SerialName(value = "rideLaterEnabled") @Required val rideLaterEnabled: kotlin.Boolean,
    @SerialName(value = "isCashEnabled") @Required val isCashEnabled: kotlin.Boolean,
    ...
    @SerialName(value = "pricingInfo") val pricingInfo: RideHailingPricingInfo? = null,
