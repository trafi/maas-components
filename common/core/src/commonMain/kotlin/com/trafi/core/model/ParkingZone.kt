 ...
 * @param code
 * @param category
 * @param encodedPolygons
 * @param tariff
 * @param supportsPayment
 * @param ext
 * @param name
 * @param position
 * @param capacity
...
data class ParkingZone(
    ...
    @SerialName(value = "encodedPolygons") @Required val encodedPolygons: kotlin.collections.List<kotlin.String>,
    @SerialName(value = "tariff") @Required val tariff: kotlin.collections.List<Tariff>,
    @SerialName(value = "supportsPayment") @Required val supportsPayment: kotlin.Boolean,
    @SerialName(value = "ext") @Required val ext: kotlin.collections.Map<kotlin.String, kotlin.String>,
    @SerialName(value = "name") val name: kotlin.String? = null,
    @SerialName(value = "position") val position: LatLng? = null,
    @SerialName(value = "capacity") val capacity: Capacity? = null,
