...
data class Disruption(
    @SerialName(value = "severity") @Required val severity: Disruption.Severity,
    @SerialName(value = "fromTime") @Required val fromTime: kotlin.String,
    @SerialName(value = "toTime") @Required val toTime: kotlin.String,
    @SerialName(value = "affectedSchedules") @Required val affectedSchedules: kotlin.collections.List<AffectedSchedule>,
    ...
    enum class Severity(val value: kotlin.String) {
        ...
        object Serializer : CommonEnumSerializer<Severity>("Severity", values(), values().map { it.value.toString() }.toTypedArray())
    }
}
