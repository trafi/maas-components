...
data class Station(
    ...
    @SerialName(value = "vehicleType") val vehicleType: Station.VehicleType? = null,
    @SerialName(value = "name") val name: kotlin.String? = null,
    @SerialName(value = "availableVehicles") val availableVehicles: kotlin.Int? = null,
    @SerialName(value = "freeSpots") val freeSpots: kotlin.Int? = null,
    @SerialName(value = "isOpen") val isOpen: kotlin.Boolean? = null
) {
