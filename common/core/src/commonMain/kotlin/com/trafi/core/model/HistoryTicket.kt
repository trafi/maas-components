...
data class HistoryTicket(
    ...
    @SerialName(value = "properties") @Required val properties: kotlin.collections.List<PropertyValue>,
    @SerialName(value = "textResources") @Required val textResources: kotlin.collections.List<LocalizedPropertyValues>,
