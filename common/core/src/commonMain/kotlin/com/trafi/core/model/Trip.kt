...
@Serializable
data class Trip(
    @SerialName(value = "start") @Required val start: SpaceTime,
    @SerialName(value = "end") @Required val end: SpaceTime,
    @SerialName(value = "timePaused") val timePaused: kotlin.String? = null,
    @SerialName(value = "polyline") val polyline: kotlin.String? = null,
    @SerialName(value = "distance") val distance: Distance? = null,
    @SerialName(value = "originalPrice") val originalPrice: kotlin.Double? = null
)
