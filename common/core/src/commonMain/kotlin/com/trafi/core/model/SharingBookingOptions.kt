...
/**
 *
 * @param allowedActions A list of supported booking actions, depending on the current booking status
 * @param requiresLocationOnCreateBooking The MSP requires user location to create a booking
 * @param requiresLocationOnFinishBooking The MSP requires user location to finish a booking
 */
@Serializable
data class SharingBookingOptions(
    /* A list of supported booking actions, depending on the current booking status */
    @SerialName(value = "allowedActions") @Required val allowedActions: kotlin.collections.List<SharingAllowedAction>,
    /* The MSP requires user location to create a booking */
    @SerialName(value = "requiresLocationOnCreateBooking") val requiresLocationOnCreateBooking: kotlin.Boolean? = null,
    /* The MSP requires user location to finish a booking */
