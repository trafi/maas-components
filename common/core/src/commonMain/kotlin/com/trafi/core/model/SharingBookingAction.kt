...
enum class SharingBookingAction(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is SharingBookingAction) "$data" else null

        /**
         * Returns a valid [SharingBookingAction] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): SharingBookingAction? = data?.let {
