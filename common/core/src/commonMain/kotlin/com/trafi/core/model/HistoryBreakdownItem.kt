...
data class HistoryBreakdownItem(
    @SerialName(value = "type") @Required val type: HistoryBreakdownItem.Type,
    @SerialName(value = "amount") @Required val amount: kotlin.Double
) {

    /**
     *
     * Values: UNKNOWN,RIDE_PRICE,OUTER_ZONE_PARKING_FEE,UNLOCK_FEE,USER_REGISTRATION_FEE
     */
    @Serializable(with = Type.Serializer::class)
    enum class Type(val value: kotlin.String) {
        UNKNOWN("UNKNOWN"),
        RIDE_PRICE("RIDE_PRICE"),
        OUTER_ZONE_PARKING_FEE("OUTER_ZONE_PARKING_FEE"),
