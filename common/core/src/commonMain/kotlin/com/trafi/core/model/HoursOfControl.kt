 ...
 * @param toWeekday
 * @param toWeekdayId
 * @param fromLocalDayTimeSeconds
 * @param toLocalDayTimeSeconds
 * @param maxParkingTimeSeconds
 */
@Serializable
data class HoursOfControl(
    @SerialName(value = "fromWeekday") @Required val fromWeekday: kotlin.String,
    @SerialName(value = "fromWeekdayId") @Required val fromWeekdayId: kotlin.Int,
    @SerialName(value = "toWeekday") @Required val toWeekday: kotlin.String,
    @SerialName(value = "toWeekdayId") @Required val toWeekdayId: kotlin.Int,
    @SerialName(value = "fromLocalDayTimeSeconds") @Required val fromLocalDayTimeSeconds: kotlin.Int,
    @SerialName(value = "toLocalDayTimeSeconds") @Required val toLocalDayTimeSeconds: kotlin.Int,
    @SerialName(value = "maxParkingTimeSeconds") val maxParkingTimeSeconds: kotlin.Int? = null
)
