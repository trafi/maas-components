...
data class AccountProvider(
    ...
    @SerialName(value = "terms") val terms: kotlin.collections.List<Terms>? = null,
    @SerialName(value = "isLevel3") val isLevel3: kotlin.Boolean? = null,
    @SerialName(value = "features") val features: AccountProviderFeatures? = null,
    @SerialName(value = "registrationDeepLinkIos") val registrationDeepLinkIos: DeepLink? = null,
    @SerialName(value = "registrationDeepLinkAndroid") val registrationDeepLinkAndroid: DeepLink? = null,
    @SerialName(value = "connectionParameters") val connectionParameters: kotlin.collections.Map<kotlin.String, kotlin.String>? = null
)
