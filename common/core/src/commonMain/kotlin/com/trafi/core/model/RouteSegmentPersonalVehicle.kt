...
data class RouteSegmentPersonalVehicle (
    @SerialName(value = "drivingInfo")
    val drivingInfo: DrivingInfo,
    @SerialName(value = "distance")
    val distance: Distance,
    @SerialName(value = "vehicle")
    val vehicle: RouteSegmentPersonalVehicle.Vehicle
) {

    /**
     *
     * Values: BICYCLE,KICK_SCOOTER
     */
    @Serializable(with = Vehicle.Serializer::class)
    enum class Vehicle(val value: kotlin.String){
        BICYCLE("BICYCLE"),
        KICK_SCOOTER("KICK_SCOOTER");

        object Serializer : CommonEnumSerializer<Vehicle>("Vehicle", values(), values().map { it.value.toString() }.toTypedArray())
    }
}
