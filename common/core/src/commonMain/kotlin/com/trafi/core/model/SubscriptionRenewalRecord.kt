 ...
 * @param renewalType
 * @param renewedAt
 * @param allowanceParts
 * @param payment
 * @param purchaseId
 */
@Serializable
data class SubscriptionRenewalRecord(
    @SerialName(value = "bookingId") @Required val bookingId: kotlin.String,
    @SerialName(value = "renewalType") @Required val renewalType: SubscriptionRenewalRecord.RenewalType,
    @SerialName(value = "renewedAt") @Required val renewedAt: kotlin.String,
    @SerialName(value = "allowanceParts") @Required val allowanceParts: HistoryAllowanceParts,
    @SerialName(value = "payment") @Required val payment: Payment,
    @SerialName(value = "purchaseId") @Required val purchaseId: kotlin.String
) {

    /**
     *
     * Values: UNKNOWN,NEW_SUBSCRIPTION,RENEWAL,SWITCH
     */
    @Serializable(with = RenewalType.Serializer::class)
    enum class RenewalType(val value: kotlin.String) {
        ...
        object Serializer : CommonEnumSerializer<RenewalType>("RenewalType", values(), values().map { it.value.toString() }.toTypedArray())
    }
}
