...
data class RideHailingRecord(
    ...
    @SerialName(value = "trip") val trip: Trip? = null,
    @SerialName(value = "cancelledTrip") val cancelledTrip: CancelledTrip? = null,
    @SerialName(value = "driver") val driver: HistoryDriver? = null,
    @SerialName(value = "car") val car: HistoryCar? = null,
    @SerialName(value = "payment") val payment: Payment? = null,
    @SerialName(value = "status") val status: RideHailingRecord.Status? = null
) {
