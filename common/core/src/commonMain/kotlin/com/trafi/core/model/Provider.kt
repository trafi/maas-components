...
data class Provider(
    ...
    @SerialName(value = "sharingOptions") @Required val sharingOptions: kotlin.collections.List<SharingProviderOptions>,
    @SerialName(value = "rideHailingOptions") @Required val rideHailingOptions: kotlin.collections.List<RideHailingProviderOptions>,
    ...
    @SerialName(value = "supportPhoneNumber") val supportPhoneNumber: kotlin.String? = null,
    @SerialName(value = "faq") val faq: Faq? = null,
    @SerialName(value = "sharingPricing") val sharingPricing: SharingPricingInfo? = null,
    @SerialName(value = "rideHailingPricing") val rideHailingPricing: RideHailingPricingInfo? = null
)
