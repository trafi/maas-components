 ...
 *
 * @param phoneNumber
 * @param verificationCode When initiating phone validation set this to null
 * @param template SMS template, must contain \"{0}\", it will be replaced with code in a message, e.g. \"Your code: {0}\"
 */
@Serializable
data class VerifyPhoneNumberParameters(
    @SerialName(value = "phoneNumber") @Required val phoneNumber: kotlin.String,
    /* When initiating phone validation set this to null */
    @SerialName(value = "verificationCode") val verificationCode: kotlin.String? = null,
    /* SMS template, must contain \"{0}\", it will be replaced with code in a message, e.g. \"Your code: {0}\" */
