 ...
 * @param version
 * @param localizedTerms
 * @param isRequired
 * @param agreedByDefault
 * @param type
 */
@Serializable
data class PlatformTerms(
    @SerialName(value = "key") @Required val key: kotlin.String,
    @SerialName(value = "titleTranslationKey") @Required val titleTranslationKey: kotlin.String,
    @SerialName(value = "version") @Required val version: kotlin.String,
    @SerialName(value = "localizedTerms") @Required val localizedTerms: kotlin.collections.List<LocalizedTerms>,
    @SerialName(value = "isRequired") @Required val isRequired: kotlin.Boolean,
    @SerialName(value = "agreedByDefault") @Required val agreedByDefault: kotlin.Boolean,
    @SerialName(value = "type") @Required val type: PlatformTerms.Type
) {

    /**
     *
     * Values: UNKNOWN,ANALYTICS_OPT_OUT,PROMOTION,ANALYSIS,ADVERTISING
     */
