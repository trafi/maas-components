 ...
 */
@Serializable
data class ResourceSpecifier(
    @SerialName(value = "realm") val realm: kotlin.String? = null,
    @SerialName(value = "msp") val msp: kotlin.String? = null,
    @SerialName(value = "vehicleType") val vehicleType: kotlin.String? = null,
    @SerialName(value = "providerAccountType") val providerAccountType: kotlin.String? = null
)
