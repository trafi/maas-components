...
import com.trafi.core.model.AccountProviderFeatures
import com.trafi.core.model.DeepLink
import com.trafi.core.model.Terms
...
data class AccountProvider (
    ...
    @Json(name = "terms")
    val terms: kotlin.collections.List<Terms>? = null,
    @Json(name = "isLevel3")
    val isLevel3: kotlin.Boolean? = null,
    @Json(name = "features")
    val features: AccountProviderFeatures? = null,
    @Json(name = "registrationDeepLinkIos")
    val registrationDeepLinkIos: DeepLink? = null,
    @Json(name = "registrationDeepLinkAndroid")
    val registrationDeepLinkAndroid: DeepLink? = null,
    @Json(name = "connectionParameters")
    val connectionParameters: kotlin.collections.Map<kotlin.String, kotlin.String>? = null
) : Parcelable
