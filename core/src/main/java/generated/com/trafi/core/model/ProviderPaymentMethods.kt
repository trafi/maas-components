...
import com.trafi.core.model.UsersMoney
...
/**
 * 
 * @param defaultMethodId 
 * @param methods 
 * @param balance 
 */
@Parcelize

data class ProviderPaymentMethods (
    @Json(name = "defaultMethodId")
    val defaultMethodId: kotlin.String,
    @Json(name = "methods")
    val methods: kotlin.collections.List<ProviderPaymentMethod>,
    @Json(name = "balance")
    val balance: UsersMoney? = null
) : Parcelable
