...
import com.trafi.core.model.TicketsProviderFeatures
...
data class TicketsProvider (
    @Json(name = "isLevel3")
    val isLevel3: kotlin.Boolean,
    @Json(name = "id")
    val id: kotlin.String,
    @Json(name = "features")
    val features: TicketsProviderFeatures,
    @Json(name = "options")
    val options: TicketsProviderOptions? = null,
    @Json(name = "name")
