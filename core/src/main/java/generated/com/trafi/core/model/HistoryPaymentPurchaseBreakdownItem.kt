...
import com.trafi.core.model.HistorySharingPurchaseBreakdownInfo
 ...
 * 
 * @param amount 
 * @param vatRatePercent 
 * @param vatAmount 
 * @param sharing 
 */
@Parcelize

data class HistoryPaymentPurchaseBreakdownItem (
    @Json(name = "amount")
    val amount: kotlin.Double? = null,
    @Json(name = "vatRatePercent")
    val vatRatePercent: kotlin.Double? = null,
    @Json(name = "vatAmount")
    val vatAmount: kotlin.Double? = null,
    @Json(name = "sharing")
    val sharing: HistorySharingPurchaseBreakdownInfo? = null
) : Parcelable
