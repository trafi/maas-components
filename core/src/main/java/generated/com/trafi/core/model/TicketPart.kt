...
import com.trafi.core.model.ProductArgument
import com.trafi.core.model.QrCode
import com.trafi.core.model.TicketValidity
...
data class TicketPart (
    @Json(name = "id")
    val id: kotlin.String? = null,
    @Json(name = "status")
    val status: TicketPart.Status? = null,
    @Json(name = "qrCode")
    ...
    @Json(name = "arguments")
    val arguments: kotlin.collections.List<ProductArgument>? = null
) : Parcelable {

    /**
    * 
    * Values: NONE,UNUSED,ACTIVE,ENDED,EXPIRED,SCHEDULED
    */
