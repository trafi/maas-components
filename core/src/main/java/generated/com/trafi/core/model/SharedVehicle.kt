...
import com.trafi.core.model.LocalizedDeepLink
...
data class SharedVehicle (
    ...
    @Json(name = "ext")
    val ext: kotlin.collections.Map<kotlin.String, kotlin.String>? = null
) : Parcelable {
    ...
    */
    ...
    enum class VehicleType(val value: kotlin.String){
        ...
        @Json(name = "BICYCLE") BICYCLE("BICYCLE"),
        @Json(name = "SCOOTER") SCOOTER("SCOOTER"),
        @Json(name = "KICK_SCOOTER") KICK_SCOOTER("KICK_SCOOTER");
    }
}
