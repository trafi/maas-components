...
import com.trafi.core.model.DocumentVerificationSession
...
data class CreateDrivingLicenceVerificationSessionResponse (
    @Json(name = "session")
    val session: DocumentVerificationSession? = null
) : Parcelable
