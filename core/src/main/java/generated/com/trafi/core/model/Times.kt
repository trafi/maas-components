...
import com.trafi.core.model.ExactTime
...
data class Times (
    @Json(name = "weekdaysId")
    val weekdaysId: kotlin.Int,
    @Json(name = "weekdays")
    val weekdays: kotlin.collections.List<kotlin.String>,
    @Json(name = "exactTimes")
    val exactTimes: kotlin.collections.List<ExactTime>,
    @Json(name = "intervalTimes")
    val intervalTimes: kotlin.collections.List<IntervalTime>
) : Parcelable
