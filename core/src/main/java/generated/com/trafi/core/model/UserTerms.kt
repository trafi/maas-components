...
import com.trafi.core.model.AcceptedPlatformTerms
import com.trafi.core.model.AcceptedProviderTerms
import com.trafi.core.model.DeclinedPlatformTerms
import com.trafi.core.model.DeclinedProviderTerms
 ...
 * @param platformTerms 
 * @param providerTerms 
 * @param declinedPlatformTerms 
 * @param declinedProviderTerms 
 */
@Parcelize

data class UserTerms (
    @Json(name = "platformTerms")
    val platformTerms: kotlin.collections.List<AcceptedPlatformTerms>,
    @Json(name = "providerTerms")
    val providerTerms: kotlin.collections.List<AcceptedProviderTerms>,
    @Json(name = "declinedPlatformTerms")
    val declinedPlatformTerms: kotlin.collections.List<DeclinedPlatformTerms>,
    @Json(name = "declinedProviderTerms")
    val declinedProviderTerms: kotlin.collections.List<DeclinedProviderTerms>
) : Parcelable
