...
import com.trafi.core.model.RequirementStatus
 ...
 * 
 * @param user 
 * @param requirementInterdependence 
 * @param requirementStatuses 
 */
@Parcelize

data class RequirementStatusResponse (
    @Json(name = "user")
    val user: User,
    @Json(name = "requirementInterdependence")
    val requirementInterdependence: kotlin.collections.Map<kotlin.String, kotlin.collections.List<kotlin.String>>,
    @Json(name = "requirementStatuses")
    val requirementStatuses: kotlin.collections.Map<kotlin.String, RequirementStatus>
) : Parcelable
