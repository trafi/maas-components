...
import com.trafi.core.model.ScheduleAtStop
...
data class AutoCompleteLocation (
    ...
    @Json(name = "type")
    val type: AutoCompleteLocation.Type,
    @Json(name = "name")
    ...
    @Json(name = "schedules")
    val schedules: kotlin.collections.List<ScheduleAtStop>? = null,
    @Json(name = "transports")
    val transports: kotlin.collections.List<Transport>? = null,
    ...
    */
    ...
    enum class Type(val value: kotlin.String){
        @Json(name = "LOCATION_TYPE_NONE") LOCATION_TYPE_NONE("LOCATION_TYPE_NONE"),
        @Json(name = "STOPS") STOPS("STOPS"),
        @Json(name = "POI") POI("POI"),
        @Json(name = "ADDRESS") ADDRESS("ADDRESS"),
        @Json(name = "COORDINATE") COORDINATE("COORDINATE"),
        @Json(name = "CURRENT_LOCATION") CURRENT_LOCATION("CURRENT_LOCATION");
    }
}
