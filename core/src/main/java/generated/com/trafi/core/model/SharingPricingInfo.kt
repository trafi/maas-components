...
import com.trafi.core.model.FeeInfo
import com.trafi.core.model.SharingPricing
...
data class SharingPricingInfo (
    ...
    @Json(name = "current")
    val current: SharingPricing? = null,
    @Json(name = "workday")
    val workday: SharingPricing? = null,
    @Json(name = "weekend")
    val weekend: SharingPricing? = null,
    @Json(name = "parking")
    val parking: SharingPricing? = null,
    @Json(name = "feeInfo")
    val feeInfo: kotlin.collections.List<FeeInfo>? = null
) : Parcelable
