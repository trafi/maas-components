...
import com.trafi.core.model.FareEstimate
...
data class RideHailingBookingEstimate (
    ...
    @Json(name = "requestContext")
    val requestContext: kotlin.String,
    @Json(name = "start")
    val start: Location,
    @Json(name = "end")
    val end: Location,
    ...
    @Json(name = "fareEstimate")
    val fareEstimate: FareEstimate? = null,
    @Json(name = "polyline")
    val polyline: kotlin.String? = null,
    @Json(name = "emptyStateMessageKey")
    val emptyStateMessageKey: kotlin.String? = null,
    @Json(name = "offerTimeout")
    val offerTimeout: kotlin.String? = null
) : Parcelable
