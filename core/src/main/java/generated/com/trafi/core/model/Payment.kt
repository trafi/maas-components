...
import com.trafi.core.model.HistoryMoney
import com.trafi.core.model.HistoryPaymentMethod
import com.trafi.core.model.HistoryPriceBreakdown
import com.trafi.core.model.HistoryPurchaseBreakdown
...
data class Payment (
    @Json(name = "price")
    val price: HistoryMoney,
    @Json(name = "priceBreakdown")
    val priceBreakdown: HistoryPriceBreakdown? = null,
    @Json(name = "purchaseBreakdown")
    val purchaseBreakdown: HistoryPurchaseBreakdown? = null,
    @Json(name = "method")
    val method: HistoryPaymentMethod? = null,
    @Json(name = "invoiceUrls")
    val invoiceUrls: kotlin.collections.List<kotlin.String>? = null,
    @Json(name = "isInvoiceAvailable")
    val isInvoiceAvailable: kotlin.Boolean? = null
) : Parcelable
