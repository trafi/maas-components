...
import com.trafi.core.model.PropertyValues
...
data class StopArgumentRestriction (
    @Json(name = "propertyRestrictions")
    val propertyRestrictions: kotlin.collections.List<PropertyValues>? = null
) : Parcelable
