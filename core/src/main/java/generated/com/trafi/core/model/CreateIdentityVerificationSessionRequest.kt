...
import com.trafi.core.model.IdentityVerificationDocument
...
data class CreateIdentityVerificationSessionRequest (
    @Json(name = "document")
    val document: IdentityVerificationDocument? = null,
    @Json(name = "settings")
