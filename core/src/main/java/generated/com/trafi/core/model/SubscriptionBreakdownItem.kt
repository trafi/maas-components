...
import com.trafi.core.model.SharingBreakdownItem
...
/**
 * 
 * @param subscriptionAllowanceTransactionId 
 * @param sharing 
 */
@Parcelize

data class SubscriptionBreakdownItem (
    @Json(name = "subscriptionAllowanceTransactionId")
    val subscriptionAllowanceTransactionId: kotlin.Int? = null,
    @Json(name = "sharing")
    val sharing: SharingBreakdownItem? = null
) : Parcelable
