...
import com.trafi.core.model.AdditionalFee
...
data class RideHailingPricing (
    @Json(name = "additionalFees")
    val additionalFees: kotlin.collections.List<AdditionalFee>,
    @Json(name = "minimumKilometers")
    val minimumKilometers: kotlin.Double? = null,
    ...
    @Json(name = "waitPerMinute")
    val waitPerMinute: kotlin.Double? = null,
    @Json(name = "ridePerMinute")
    val ridePerMinute: kotlin.Double? = null
) : Parcelable
