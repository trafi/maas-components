...
import com.trafi.core.model.ActivateCountArgumentRestriction
import com.trafi.core.model.DateTimeArgumentRestriction
import com.trafi.core.model.StopArgumentRestriction
 ...
 * 
 * @param type 
 * @param stopRestriction 
 * @param dateTimeRestriction 
 * @param activateCountRestriction 
 */
@Parcelize

data class ProductArgumentWithRestriction (
    @Json(name = "type")
    val type: ProductArgumentWithRestriction.Type? = null,
    @Json(name = "stopRestriction")
    val stopRestriction: StopArgumentRestriction? = null,
    @Json(name = "dateTimeRestriction")
    val dateTimeRestriction: DateTimeArgumentRestriction? = null,
    @Json(name = "activateCountRestriction")
    val activateCountRestriction: ActivateCountArgumentRestriction? = null
) : Parcelable {

    /**
    * 
    * Values: NONE,STOP,DATE_TIME,ACTIVATE_COUNT
    */
    ...
    enum class Type(val value: kotlin.String){
        ...
        @Json(name = "ACTIVATE_COUNT") ACTIVATE_COUNT("ACTIVATE_COUNT");
    }
}
