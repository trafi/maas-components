...
import com.trafi.core.model.ActivateCountArgument
import com.trafi.core.model.DateTimeArgument
import com.trafi.core.model.StopArgument
...
data class ProductArgument (
    @Json(name = "type")
    val type: ProductArgument.Type? = null,
    @Json(name = "stop")
    val stop: StopArgument? = null,
    @Json(name = "dateTime")
    val dateTime: DateTimeArgument? = null,
    @Json(name = "activateCount")
    val activateCount: ActivateCountArgument? = null
) : Parcelable {
