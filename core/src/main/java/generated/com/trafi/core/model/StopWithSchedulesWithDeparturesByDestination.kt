...
import com.trafi.core.model.ScheduleWithDeparturesByDestination
...
data class StopWithSchedulesWithDeparturesByDestination (
    @Json(name = "stop")
    val stop: Stop,
    @Json(name = "now")
    val now: kotlin.String,
    @Json(name = "scheduleDepartures")
    val scheduleDepartures: kotlin.collections.List<ScheduleWithDeparturesByDestination>
) : Parcelable
