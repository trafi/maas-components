...
import com.trafi.core.model.LocalizedTerms
...
data class PlatformTerms (
    ...
    @Json(name = "localizedTerms")
    val localizedTerms: kotlin.collections.List<LocalizedTerms>,
    @Json(name = "isRequired")
    val isRequired: kotlin.Boolean,
    @Json(name = "agreedByDefault")
    val agreedByDefault: kotlin.Boolean,
    @Json(name = "type")
    val type: PlatformTerms.Type
) : Parcelable {
    ...
    */
    ...
    enum class Type(val value: kotlin.String){
        ...
        @Json(name = "ANALYTICS_OPT_OUT") ANALYTICS_OPT_OUT("ANALYTICS_OPT_OUT"),
        @Json(name = "PROMOTION") PROMOTION("PROMOTION"),
        @Json(name = "ANALYSIS") ANALYSIS("ANALYSIS"),
        @Json(name = "ADVERTISING") ADVERTISING("ADVERTISING");
    }
}
