...
data class RideHailingProduct (
    ...
    @Json(name = "rideLaterEnabled")
    val rideLaterEnabled: kotlin.Boolean,
    @Json(name = "isCashEnabled")
    val isCashEnabled: kotlin.Boolean,
    ...
    @Json(name = "pricingInfo")
    val pricingInfo: RideHailingPricingInfo? = null,
    @Json(name = "operationRestrictions")
    val operationRestrictions: OperationRestrictions? = null
) : Parcelable
