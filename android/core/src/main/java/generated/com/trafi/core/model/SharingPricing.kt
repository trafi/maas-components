...
import com.trafi.core.model.Fee
import com.trafi.core.model.TimeIntervalPricing
...
data class SharingPricing (
    @Json(name = "minimum")
    val minimum: kotlin.Double? = null,
    @Json(name = "minimumMinutes")
    val minimumMinutes: kotlin.Int? = null,
    @Json(name = "base")
    val base: kotlin.Double? = null,
    @Json(name = "minute")
    val minute: kotlin.Double? = null,
    @Json(name = "hour")
    val hour: kotlin.Double? = null,
    @Json(name = "day")
    val day: kotlin.Double? = null,
    @Json(name = "week")
    val week: kotlin.Double? = null,
    @Json(name = "perKilometer")
    val perKilometer: kotlin.Double? = null,
    @Json(name = "freeKilometers")
    val freeKilometers: kotlin.Double? = null,
    @Json(name = "timeIntervalPrices")
    val timeIntervalPrices: kotlin.collections.List<TimeIntervalPricing>? = null,
    @Json(name = "fees")
