...
data class Disruption (
    @Json(name = "severity")
    val severity: Disruption.Severity,
    @Json(name = "fromTime")
    val fromTime: kotlin.String,
    @Json(name = "toTime")
    val toTime: kotlin.String,
    @Json(name = "affectedSchedules")
    val affectedSchedules: kotlin.collections.List<AffectedSchedule>,
    @Json(name = "title")
    ...
    */
    ...
    enum class Severity(val value: kotlin.String){
        @Json(name = "NOT_AFFECTED") NOT_AFFECTED("NOT_AFFECTED"),
        @Json(name = "INFORMATION") INFORMATION("INFORMATION"),
