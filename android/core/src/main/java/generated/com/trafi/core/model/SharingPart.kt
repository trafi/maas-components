...
import com.trafi.core.model.BalanceDuration
import com.trafi.core.model.BalanceMeters
...
data class SharingPart (
    @Json(name = "id")
    val id: kotlin.String,
    @Json(name = "providers")
    val providers: kotlin.collections.List<SharingProvider>,
    @Json(name = "duration")
    val duration: BalanceDuration? = null,
    @Json(name = "meters")
    val meters: BalanceMeters? = null
) : Parcelable
