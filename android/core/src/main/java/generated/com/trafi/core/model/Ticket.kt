...
import com.trafi.core.model.TicketMetadata
import com.trafi.core.model.TicketPart
...
data class Ticket (
    @Json(name = "purchasedAt")
    val purchasedAt: kotlin.String,
    @Json(name = "id")
    ...
    @Json(name = "parts")
    val parts: kotlin.collections.List<TicketPart>? = null,
    @Json(name = "productId")
