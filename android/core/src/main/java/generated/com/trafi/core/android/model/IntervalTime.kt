...
data class IntervalTime (
    @Json(name = "fromSecondsAfterMidnight")
    val fromSecondsAfterMidnight: kotlin.Int,
    @Json(name = "toSecondsAfterMidnight")
    val toSecondsAfterMidnight: kotlin.Int,
    @Json(name = "frequencySeconds")
    val frequencySeconds: kotlin.Int,
    @Json(name = "tripId")
