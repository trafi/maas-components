...
import com.trafi.core.model.SubscriptionAllowance
import com.trafi.core.model.SubscriptionPlan
...
data class Subscription (
    ...
    @Json(name = "subscribedAt")
    val subscribedAt: kotlin.String,
    @Json(name = "kicksIn")
    val kicksIn: kotlin.String,
    @Json(name = "expiryPeriod")
    val expiryPeriod: kotlin.String,
    @Json(name = "subregionId")
    val subregionId: kotlin.String? = null,
    @Json(name = "currentAllowance")
    val currentAllowance: SubscriptionAllowance? = null
) : Parcelable {

    /**
    * 
    * Values: RENEWAL_ENABLED,RENEWAL_DISABLED,INACTIVE
    */
    
    enum class Status(val value: kotlin.String){
        @Json(name = "RENEWAL_ENABLED") RENEWAL_ENABLED("RENEWAL_ENABLED"),
        @Json(name = "RENEWAL_DISABLED") RENEWAL_DISABLED("RENEWAL_DISABLED"),
