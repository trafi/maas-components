...
data class HistoryBreakdownItem (
    @Json(name = "type")
    val type: HistoryBreakdownItem.Type,
    @Json(name = "amount")
    ...
    /**
    * 
    * Values: UNKNOWN,RIDE_PRICE,OUTER_ZONE_PARKING_FEE,UNLOCK_FEE
    */
    
    enum class Type(val value: kotlin.String){
        @Json(name = "UNKNOWN") UNKNOWN("UNKNOWN"),
        @Json(name = "RIDE_PRICE") RIDE_PRICE("RIDE_PRICE"),
        @Json(name = "OUTER_ZONE_PARKING_FEE") OUTER_ZONE_PARKING_FEE("OUTER_ZONE_PARKING_FEE"),
        @Json(name = "UNLOCK_FEE") UNLOCK_FEE("UNLOCK_FEE");
    }
}
