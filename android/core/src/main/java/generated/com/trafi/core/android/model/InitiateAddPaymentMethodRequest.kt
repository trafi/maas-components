...
data class InitiateAddPaymentMethodRequest (
    @Json(name = "redirectUrlCancel")
    val redirectUrlCancel: kotlin.String,
    @Json(name = "redirectUrlSuccess")
    val redirectUrlSuccess: kotlin.String,
    @Json(name = "redirectUrlPending")
    val redirectUrlPending: kotlin.String? = null,
    @Json(name = "redirectUrlFailure")
    val redirectUrlFailure: kotlin.String? = null
) : Parcelable
