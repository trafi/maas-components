...
import com.trafi.core.model.HistoryBalanceDuration
import com.trafi.core.model.HistoryBalanceMeters
import com.trafi.core.model.HistorySharingProvider
...
data class HistorySharingPart (
    @Json(name = "id")
    val id: kotlin.String,
    @Json(name = "providers")
    val providers: kotlin.collections.List<HistorySharingProvider>,
    @Json(name = "duration")
    val duration: HistoryBalanceDuration? = null,
    @Json(name = "meters")
    val meters: HistoryBalanceMeters? = null
) : Parcelable
