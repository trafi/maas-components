...
import com.trafi.core.model.HistoryAllowanceParts
...
data class SubscriptionRenewalRecord (
    ...
    val renewalType: SubscriptionRenewalRecord.RenewalType,
    @Json(name = "renewedAt")
    val renewedAt: kotlin.String,
    @Json(name = "allowanceParts")
    val allowanceParts: HistoryAllowanceParts,
    @Json(name = "payment")
    val payment: Payment,
    ...
    */
    ...
    enum class RenewalType(val value: kotlin.String){
        ...
        @Json(name = "NEW_SUBSCRIPTION") NEW_SUBSCRIPTION("NEW_SUBSCRIPTION"),
