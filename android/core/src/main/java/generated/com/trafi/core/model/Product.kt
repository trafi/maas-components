...
import com.trafi.core.model.LocalizedPropertyValues
import com.trafi.core.model.PricingInfo
import com.trafi.core.model.ProductArgumentWithRestriction
import com.trafi.core.model.PropertyValue
 ...
 * @param properties 
 * @param textResources 
 * @param requiredArgumentsWithRestrictions 
 * @param price 
 * @param maxBuyProductItemCount 
 * @param ticketPartsCount 
 */
@Parcelize
...
data class Product (
    ...
    @Json(name = "textResources")
    val textResources: kotlin.collections.List<LocalizedPropertyValues>? = null,
    @Json(name = "requiredArgumentsWithRestrictions")
    val requiredArgumentsWithRestrictions: kotlin.collections.List<ProductArgumentWithRestriction>? = null,
    @Json(name = "price")
    val price: PricingInfo? = null,
    @Json(name = "maxBuyProductItemCount")
    val maxBuyProductItemCount: kotlin.Int? = null,
    @Json(name = "ticketPartsCount")
    val ticketPartsCount: kotlin.Int? = null
) : Parcelable
