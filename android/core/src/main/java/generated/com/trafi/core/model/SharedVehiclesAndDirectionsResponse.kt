...
import com.trafi.core.model.SharedVehicleWithDirections
...
data class SharedVehiclesAndDirectionsResponse (
    @Json(name = "vehicles")
    val vehicles: kotlin.collections.List<SharedVehicleWithDirections>
) : Parcelable
