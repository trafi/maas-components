...
data class CreateSharingBookingRequest (
    ...
    @Json(name = "providerPaymentMethodId")
    val providerPaymentMethodId: kotlin.String? = null,
    ...
    @Json(name = "initialBookingStatus")
    val initialBookingStatus: CreateSharingBookingRequest.InitialBookingStatus? = null
) : Parcelable {
