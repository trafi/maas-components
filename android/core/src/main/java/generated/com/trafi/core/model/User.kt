...
import com.trafi.core.model.Membership
import com.trafi.core.model.PaymentMethods
...
data class User (
    ...
    @Json(name = "providerAccounts")
    val providerAccounts: kotlin.collections.List<ProviderAccount>,
    @Json(name = "drivingLicence")
    ...
    val memberships: kotlin.collections.List<Membership>? = null
) : Parcelable
