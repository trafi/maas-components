...
data class MspRequirements (
    @Json(name = "resourceSpecifier")
    val resourceSpecifier: ResourceSpecifier? = null,
    @Json(name = "requirementStatuses")
    val requirementStatuses: kotlin.collections.Map<kotlin.String, RequirementStatus>? = null
) : Parcelable
