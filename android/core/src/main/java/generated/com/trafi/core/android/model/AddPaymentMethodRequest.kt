...
data class AddPaymentMethodRequest (
    @Json(name = "type")
    val type: AddPaymentMethodRequest.Type,
    @Json(name = "encryptedPaymentMethod")
    val encryptedPaymentMethod: kotlin.String,
    @Json(name = "ext")
    ...
    */
    ...
    enum class Type(val value: kotlin.String){
        ...
        @Json(name = "DIRECT_DEBIT") DIRECT_DEBIT("DIRECT_DEBIT"),
        @Json(name = "PAY_PAL") PAY_PAL("PAY_PAL"),
