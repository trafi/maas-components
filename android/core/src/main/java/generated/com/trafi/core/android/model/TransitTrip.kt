...
data class TransitTrip (
    ...
    @Json(name = "trackWithStops")
    val trackWithStops: TrackWithStops,
    @Json(name = "isRealtime")
    val isRealtime: kotlin.Boolean,
    @Json(name = "exactTimes")
    val exactTimes: kotlin.collections.List<TransitTripExactTime>,
    @Json(name = "intervalDurations")
    val intervalDurations: kotlin.collections.List<TransitTripIntervalDuration>,
    @Json(name = "currentStopIdx")
    val currentStopIdx: kotlin.Int? = null,
    @Json(name = "vehiclePosition")
    val vehiclePosition: TransitVehiclePosition? = null,
    @Json(name = "disruption")
    val disruption: TransitTripDisruption? = null
) : Parcelable
