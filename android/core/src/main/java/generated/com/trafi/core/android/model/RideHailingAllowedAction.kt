...
data class RideHailingAllowedAction (
    @Json(name = "bookingStatus")
    val bookingStatus: RideHailingAllowedAction.BookingStatus? = null,
    @Json(name = "action")
    val action: RideHailingAllowedAction.Action? = null
) : Parcelable {
    ...
    */
    ...
    enum class BookingStatus(val value: kotlin.String){
        ...
        @Json(name = "DRIVER_CANCELLED") DRIVER_CANCELLED("DRIVER_CANCELLED"),
        @Json(name = "RIDER_CANCELLED") RIDER_CANCELLED("RIDER_CANCELLED"),
    ...
    /**
    * 
    * Values: CREATE,CANCEL,UPDATE_DROPOFF,CONFIRM_PAYMENT
    */
    
    enum class Action(val value: kotlin.String){
        @Json(name = "CREATE") CREATE("CREATE"),
        @Json(name = "CANCEL") CANCEL("CANCEL"),
        @Json(name = "UPDATE_DROPOFF") UPDATE_DROPOFF("UPDATE_DROPOFF"),
        @Json(name = "CONFIRM_PAYMENT") CONFIRM_PAYMENT("CONFIRM_PAYMENT");
    }
}
