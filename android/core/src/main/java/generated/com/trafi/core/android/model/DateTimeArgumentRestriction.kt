 ...
 * @param onlyDateNeeded 
 * @param maxDaysInAdvance 
 */
@Parcelize

data class DateTimeArgumentRestriction (
    @Json(name = "onlyImmediately")
    val onlyImmediately: kotlin.Boolean? = null,
    @Json(name = "onlyDateNeeded")
    val onlyDateNeeded: kotlin.Boolean? = null,
    @Json(name = "maxDaysInAdvance")
    val maxDaysInAdvance: kotlin.Int? = null
) : Parcelable
