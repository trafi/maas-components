...
data class IdentityVerificationDocument (
    ...
    @Json(name = "type")
    val type: IdentityVerificationDocument.Type? = null
) : Parcelable {

    /**
    * 
    * Values: PASSPORT,ID_CARD,DRIVING_LICENCE,RESIDENCE_PERMIT
    */
    
    enum class Type(val value: kotlin.String){
        @Json(name = "PASSPORT") PASSPORT("PASSPORT"),
        @Json(name = "ID_CARD") ID_CARD("ID_CARD"),
        @Json(name = "DRIVING_LICENCE") DRIVING_LICENCE("DRIVING_LICENCE"),
        @Json(name = "RESIDENCE_PERMIT") RESIDENCE_PERMIT("RESIDENCE_PERMIT");
    }
}
