...
/**
 * 
 * @param shouldRouteFromStations 
 * @param baseDuration 
 */
@Parcelize

data class SharingRoutingOptions (
    @Json(name = "shouldRouteFromStations")
    val shouldRouteFromStations: kotlin.Boolean,
    @Json(name = "baseDuration")
    val baseDuration: kotlin.String? = null
) : Parcelable
