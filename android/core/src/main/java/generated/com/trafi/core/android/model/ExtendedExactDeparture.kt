...
data class ExtendedExactDeparture (
    @Json(name = "realtimeDepartures")
    val realtimeDepartures: kotlin.collections.List<ExactDeparture>,
    @Json(name = "scheduledDepartureStatus")
    val scheduledDepartureStatus: ExtendedExactDeparture.ScheduledDepartureStatus,
    @Json(name = "scheduledDeparture")
    val scheduledDeparture: ExactDeparture? = null
) : Parcelable {
    ...
    */
    ...
    enum class ScheduledDepartureStatus(val value: kotlin.String){
        ...
        @Json(name = "REPLACED_BY_REALTIME") REPLACED_BY_REALTIME("REPLACED_BY_REALTIME"),
        @Json(name = "COVERED_BY_REALTIME") COVERED_BY_REALTIME("COVERED_BY_REALTIME"),
        @Json(name = "UNCHANGED") UNCHANGED("UNCHANGED"),
        @Json(name = "UNMAPPED") UNMAPPED("UNMAPPED");
    }
}
