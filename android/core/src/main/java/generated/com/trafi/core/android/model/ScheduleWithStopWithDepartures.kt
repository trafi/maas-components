...
data class ScheduleWithStopWithDepartures (
    ...
    @Json(name = "extendedExactDepartures")
    val extendedExactDepartures: kotlin.collections.List<ExtendedExactDeparture>,
    @Json(name = "extendedIntervalDepartures")
    val extendedIntervalDepartures: kotlin.collections.List<ExtendedIntervalDeparture>,
    @Json(name = "track")
