...
data class TransitVehiclePosition (
    ...
    @Json(name = "location")
    val location: LatLng,
    @Json(name = "trackStopFraction")
    val trackStopFraction: kotlin.Double? = null,
    @Json(name = "angle")
    val angle: kotlin.Double? = null,
    @Json(name = "trackShape")
    val trackShape: kotlin.String? = null,
    @Json(name = "trackShapeMovementFractionalIndices")
    val trackShapeMovementFractionalIndices: kotlin.collections.List<kotlin.Float>? = null,
    @Json(name = "timestamp")
