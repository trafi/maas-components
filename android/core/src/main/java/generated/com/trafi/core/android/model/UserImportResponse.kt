...
/**
 * User import execution result
 * @param result Import execution result
 */
@Parcelize
...
data class UserImportResponse (
    ...
    @Json(name = "result")
    val result: UserImportResponse.Result? = null
) : Parcelable {
    ...
    */
    ...
    enum class Result(val value: kotlin.String){
        ...
        @Json(name = "USER_NOT_FOUND") USER_NOT_FOUND("USER_NOT_FOUND"),
        @Json(name = "EXECUTED") EXECUTED("EXECUTED"),
        @Json(name = "ALREADY_IMPORTED") ALREADY_IMPORTED("ALREADY_IMPORTED"),
        @Json(name = "EXECUTION_FAILED") EXECUTION_FAILED("EXECUTION_FAILED");
    }
}
