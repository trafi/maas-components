...
import com.trafi.core.model.CancelledTrip
import com.trafi.core.model.HistoryCar
import com.trafi.core.model.HistoryDriver
import com.trafi.core.model.Payment
import com.trafi.core.model.Trip
...
data class RideHailingRecord (
    @Json(name = "bookingId")
    val bookingId: kotlin.String,
    @Json(name = "providerId")
    val providerId: kotlin.String,
    @Json(name = "trip")
    val trip: Trip? = null,
    @Json(name = "cancelledTrip")
    val cancelledTrip: CancelledTrip? = null,
    @Json(name = "driver")
    val driver: HistoryDriver? = null,
    @Json(name = "car")
    val car: HistoryCar? = null,
    @Json(name = "payment")
    val payment: Payment? = null,
    @Json(name = "status")
    val status: RideHailingRecord.Status? = null
) : Parcelable {
