...
import com.trafi.core.model.DrivingLicenceCategory
...
data class DrivingLicence (
    ...
    val categories: kotlin.collections.List<DrivingLicenceCategory>,
    @Json(name = "verificationStatus")
    val verificationStatus: DrivingLicence.VerificationStatus,
    @Json(name = "licenceNumber")
    val licenceNumber: kotlin.String? = null,
    @Json(name = "issuedAt")
    val issuedAt: kotlin.String? = null,
    @Json(name = "expiresAt")
    val expiresAt: kotlin.String? = null,
    @Json(name = "verificationMessageKey")
    val verificationMessageKey: kotlin.String? = null,
    @Json(name = "verificationFallbackMessage")
    val verificationFallbackMessage: kotlin.String? = null
) : Parcelable {

    /**
    * 
    * Values: NOT_VERIFIED,VERIFIED,PENDING,FAILED
    */
    
    enum class VerificationStatus(val value: kotlin.String){
        @Json(name = "NOT_VERIFIED") NOT_VERIFIED("NOT_VERIFIED"),
