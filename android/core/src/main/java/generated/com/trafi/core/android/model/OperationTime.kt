...
/**
 * 
 * @param startMinutesLocal 
 * @param endMinutesLocal 
 */
@Parcelize

data class OperationTime (
    @Json(name = "startMinutesLocal")
    val startMinutesLocal: kotlin.Int,
    @Json(name = "endMinutesLocal")
    val endMinutesLocal: kotlin.Int
) : Parcelable
