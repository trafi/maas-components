...
import com.trafi.core.model.SharingProvider
 ...
 * 
 * @param providers 
 * @param durationIncluded 
 * @param metersIncluded 
 */
@Parcelize

data class SharingPlanPart (
    @Json(name = "providers")
    val providers: kotlin.collections.List<SharingProvider>,
    @Json(name = "durationIncluded")
    val durationIncluded: kotlin.String? = null,
    @Json(name = "metersIncluded")
    val metersIncluded: kotlin.Int? = null
) : Parcelable
