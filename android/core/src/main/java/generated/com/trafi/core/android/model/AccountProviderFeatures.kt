...
data class AccountProviderFeatures (
    @Json(name = "supportsConnect")
    val supportsConnect: kotlin.Boolean? = null,
    @Json(name = "supportsRegistration")
    val supportsRegistration: kotlin.Boolean? = null,
    @Json(name = "requiresPayment")
    val requiresPayment: kotlin.Boolean? = null
) : Parcelable
