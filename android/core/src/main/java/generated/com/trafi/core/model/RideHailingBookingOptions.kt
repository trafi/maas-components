...
import com.trafi.core.model.RideHailingAllowedAction
...
data class RideHailingBookingOptions (
    @Json(name = "passengerCountRequired")
    val passengerCountRequired: kotlin.Boolean? = null,
    @Json(name = "maxPassengerCount")
    val maxPassengerCount: kotlin.Int? = null,
    @Json(name = "allowedActions")
    val allowedActions: kotlin.collections.List<RideHailingAllowedAction>? = null,
    @Json(name = "supportedTags")
    val supportedTags: kotlin.collections.List<kotlin.String>? = null,
    @Json(name = "startAddressRequired")
    val startAddressRequired: kotlin.Boolean? = null,
    @Json(name = "endAddressRequired")
    val endAddressRequired: kotlin.Boolean? = null,
    @Json(name = "cancellationFee")
    val cancellationFee: kotlin.Double? = null
) : Parcelable
