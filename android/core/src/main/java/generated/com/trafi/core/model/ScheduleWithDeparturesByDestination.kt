...
import com.trafi.core.model.DestinationWithDepartures
 ...
 * 
 * @param schedule 
 * @param destinationDepartures 
 */
@Parcelize

data class ScheduleWithDeparturesByDestination (
    @Json(name = "schedule")
    val schedule: Schedule,
    @Json(name = "destinationDepartures")
    val destinationDepartures: kotlin.collections.List<DestinationWithDepartures>
) : Parcelable
