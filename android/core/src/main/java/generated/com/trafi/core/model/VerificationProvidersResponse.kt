...
import com.trafi.core.model.VerificationProvider
...
data class VerificationProvidersResponse (
    @Json(name = "providers")
    val providers: kotlin.collections.List<VerificationProvider>? = null
) : Parcelable
