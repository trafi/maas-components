 ...
 * 
 * @param sessionId 
 * @param verificationContentSubmitted 
 */
@Parcelize

data class UpdateVerificationSessionRequest (
    @Json(name = "sessionId")
    val sessionId: kotlin.String,
    @Json(name = "verificationContentSubmitted")
    val verificationContentSubmitted: kotlin.Boolean? = null
) : Parcelable
