...
/**
 * 
 * @param productsWithEta 
 */
@Parcelize

data class RideHailingProductsWithEtaResponse (
    @Json(name = "productsWithEta")
    val productsWithEta: kotlin.collections.List<RideHailingProductWithEta>
) : Parcelable
