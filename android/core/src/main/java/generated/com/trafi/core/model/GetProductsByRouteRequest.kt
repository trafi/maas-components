...
import com.trafi.core.model.RouteTransitSegment
...
data class GetProductsByRouteRequest (
    @Json(name = "transitSegments")
    val transitSegments: kotlin.collections.List<RouteTransitSegment>,
    @Json(name = "startTime")
