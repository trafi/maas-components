...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MaasCore",
            url: "https://github.com/trafi/maas-components/releases/download/0.1.0-dev04/MaasCore.xcframework.zip",
            checksum: "3f555cc745034bc3ec6cfba88a4d702bf673107a5c60f1a3ce0565732ae91266"),
